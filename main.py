...
def configure():
    ...
    flags.DEFINE_integer('max_epoch', 50, '# of step in an epoch')
    ...
    flags.DEFINE_integer('valid_end_epoch',51,'end step to test a model')
    flags.DEFINE_integer('valid_stride_of_epoch',10,'stride to test a model')
    flags.DEFINE_string('model_name', 'model', 'Model file name')
    flags.DEFINE_integer('reload_epoch', 0, 'Reload epoch')
    # flags.DEFINE_integer('test_epoch', 26501, 'Test or predict epoch')
    flags.DEFINE_integer('test_epoch', 50, 'Test or predict epoch')
    flags.DEFINE_integer('random_seed', 7, 'random seed')

    # flags.DEFINE_integer('summary_step', 10000000, '# of step to save the summary')
    flags.DEFINE_integer('summary_step', 10, '# of step to save the summary')
    #—————————————————————————————————————————————————————#
    ...
    #—————————————————————————————————————————————————————#
    flags.DEFINE_string('data_dir', '/content/herlev_lab_combo_h5/lab_10_10_80/', 'Name of data directory')
    ...
    #————————————————————————————-—————————————————————————#
    flags.DEFINE_string('logdir', '/content/herlev_lab_10_10_80/logdir', 'Log dir')
    flags.DEFINE_string('modeldir', '/content/herlev_lab_10_10_80/modeldir', 'Model dir')
    flags.DEFINE_string('sample_dir', '/content/herlev_lab_10_10_80/samples/', 'Sample directory')
    flags.DEFINE_string('record_dir', '/content/herlev_lab_10_10_80/record/', 'Experiment record directory')
    #————————————————————————————-—————————————————————————#
